...
.${a} tspan {
  white-space: pre;
}`)).call(Po,n);for(let A of f){let{channels:N,values:O,facets:R}=p.get(A);if(l===void 0||A.facet==="super"){let tt=null;if(R&&(tt=R[0],tt=A.filter(tt,N,O),tt.length===0))continue;let Z=A.render(tt,h,O,y,w);if(Z==null)continue;T.appendChild(Z)}else{let tt;for(let Z of l){if(!(A.facetAnchor?.(l,D,Z)??!Z.empty))continue;let H=null;if(R){let at=c.has(A);if(H=R[at?Z.i:0],H=A.filter(H,N,O),H.length===0)continue;!at&&H===R[0]&&(H=Cg(H)),H.fx=Z.x,H.fy=Z.y,H.fi=Z.i}let Q=A.render(H,h,O,M,w);if(Q!=null){(tt??=hn(T).append("g")).append(()=>Q).datum(Z);for(let at of["aria-label","aria-description","aria-hidden","transform"])Q.hasAttribute(at)&&(tt.attr(at,Q.getAttribute(at)),Q.removeAttribute(at))}}tt?.selectChildren().attr("transform",_)}}let P=uy(m,w,t);if(r!=null||P.length>0){E=v.createElement("figure"),E.style.maxWidth="initial";for(let A of P)E.appendChild(A);if(E.appendChild(T),r!=null){let A=v.createElement("figcaption");A.appendChild(r?.ownerDocument?r:v.createTextNode(r)),E.appendChild(A)}}E.scale=G1(m),E.legend=iy(m,w,t);let S=t1();return S>0&&hn(T).append("text").attr("x",L).attr("y",20).attr("dy","-1em").attr("text-anchor","end").attr("font-family","initial").text("\u26A0\uFE0F").append("title").text(`${S.toLocaleString("en-US")} warning${S===1?"":"s"}. Please check the console.`),E}function N5({marks:t=[],...e}={}){return Jc({...e,marks:[...t,this]})}Dt.prototype.plot=N5;function dy(t){return t.flat(1/0).filter(e=>e!=null).map(R5)}function R5(t){return typeof t.render=="function"?t:new Mp(t)}var Mp=class extends Dt{constructor(e){if(typeof e!="function")throw new TypeError("invalid mark; missing render function");super(),this.render=e}render(){}};function Sp(t,e){for(let n in t)gy(t[n],e);return t}function gy(t,e){let{scale:n,transform:r=!0}=t;if(n==null||!r)return;let{type:o,percent:i,interval:a,transform:f=i?u=>u*100:Md(a,o)}=e[n]??{};f!=null&&(t.value=pt(t.value,f),t.transform=!1)}function L5(t){for(let e in t)Rd(e,t[e])}function Ea(t,e,n,r=bg){for(let{channels:o}of e.values())for(let i in o){let a=o[i],{scale:f}=a;if(f!=null&&r(f))if(f==="projection"){if(!f1(n)){let u=n.x?.domain===void 0,c=n.y?.domain===void 0;if(u||c){let[s,d]=c1(a);u&&vp(t,"x",s),c&&vp(t,"y",d)}}}else vp(t,f,a)}return t}function vp(t,e,n){let r=t.get(e);r!==void 0?r.push(n):t.set(e,[n])}function P5(t,e){if(t==null)return;let{x:n,y:r}=t;if(n==null&&r==null)return;let o=kt(t.data);if(o==null)throw new Error("missing facet data");let i={};n!=null&&(i.fx=$o(o,{value:n,scale:"fx"})),r!=null&&(i.fy=$o(o,{value:r,scale:"fy"})),Sp(i,e);let a=Fc(o,i);return{channels:i,groups:a,data:t.data}}function py(t,e,n){if(t.facet===null||t.facet==="super")return;let{fx:r,fy:o}=t;if(r!=null||o!=null){let u=kt(t.data??r??o);if(u===void 0)throw new Error(`missing facet data in ${t.ariaLabel}`);if(u===null)return;let c={};return r!=null&&(c.fx=$o(u,{value:r,scale:"fx"})),o!=null&&(c.fy=$o(u,{value:o,scale:"fy"})),Sp(c,n),{channels:c,groups:Fc(u,c)}}if(e===void 0)return;let{channels:i,groups:a,data:f}=e;if(t.facet!=="auto"||t.data===f)return{channels:i,groups:a};f.length>0&&(a.size>1||a.size===1&&i.fx&&i.fy&&[...a][0][1].size>1)&&kt(t.data)?.length===f.length&&on(`Warning: the ${t.ariaLabel} mark appears to use faceted data, but isn\u2019t faceted. The mark data has the same length as the facet data and the mark facet option is "auto", but the mark data and facet data are distinct. If this mark should be faceted, set the mark facet option to true; otherwise, suppress this warning by setting the mark facet option to false.`)}function O5(t,e={}){return Er({...e,x:null,y:null},(n,r,o,i,a,f)=>f.getMarkState(t))}function F5(t){let e=[];for(let n of t){let r=n.tip;if(r){let i=(r==="x"?fx:r==="y"?ux:ax)(O5(n));i.title=null,e.push(ly(n.data,i))}}return e}function q5(t,e,n){let{projection:r,x:o={},y:i={},fx:a={},fy:f={},axis:u,grid:c,facet:s={},facet:{axis:d=u,grid:l}=s,x:{axis:p=u,grid:m=p===null?null:c}=o,y:{axis:h=u,grid:g=h===null?null:c}=i,fx:{axis:b=d,grid:x=b===null?null:l}=a,fy:{axis:M=d,grid:y=M===null?null:l}=f}=n;(r||!xo(o)&&!my("x",t))&&(p=m=null),(r||!xo(i)&&!my("y",t))&&(h=g=null),e.has("fx")||(b=x=null),e.has("fy")||(M=y=null),p===void 0&&(p=!Qc(t,"x")),h===void 0&&(h=!Qc(t,"y")),b===void 0&&(b=!Qc(t,"fx")),M===void 0&&(M=!Qc(t,"fy")),p===!0&&(p="bottom"),h===!0&&(h="left"),b===!0&&(b=p==="top"||p===null?"bottom":"top"),M===!0&&(M=h==="right"||h===null?"left":"right");let w=[];return Kc(w,y,Xx,f),Zc(w,M,qx,"right","left",s,f),Kc(w,x,Hx,a),Zc(w,b,Yx,"top","bottom",s,a),Kc(w,g,Ux,i),Zc(w,h,mp,"left","right",n,i),Kc(w,m,Wx,o),Zc(w,p,hp,"bottom","top",n,o),w}function Zc(t,e,n,r,o,i,a){if(!e)return;let f=Y5(e);a=z5(f?r:e,i,a);let{line:u}=a;(n===mp||n===hp)&&u&&!$r(u)&&t.push(cy(B5(a))),t.push(n(a)),f&&t.push(n({...a,anchor:o,label:null}))}function Kc(t,e,n,r){!e||$r(e)||t.push(n(U5(e,r)))}function Y5(t){return/^\s*both\s*$/i.test(t)}function z5(t,e,{line:n=e.line,ticks:r,tickSize:o,tickSpacing:i,tickPadding:a,tickFormat:f,tickRotate:u,fontVariant:c,ariaLabel:s,ariaDescription:d,label:l=e.label,labelAnchor:p,labelArrow:m=e.labelArrow,labelOffset:h}){return{anchor:t,line:n,ticks:r,tickSize:o,tickSpacing:i,tickPadding:a,tickFormat:f,tickRotate:u,fontVariant:c,ariaLabel:s,ariaDescription:d,label:l,labelAnchor:p,labelArrow:m,labelOffset:h}}function B5(t){let{anchor:e,line:n}=t;return{anchor:e,facetAnchor:e+"-empty",stroke:n===!0?void 0:n}}function U5(t,{stroke:e=wo(t)?t:void 0,ticks:n=X5(t)?t:void 0,tickSpacing:r,ariaLabel:o,ariaDescription:i}){return{stroke:e,ticks:n,tickSpacing:r,ariaLabel:o,ariaDescription:i}}function X5(t){switch(typeof t){case"number":return!0;case"string":return!wo(t)}return re(t)||typeof t?.range=="function"}function Qc(t,e){let n=`${e}-axis `;return t.some(r=>r.ariaLabel?.startsWith(n))}function my(t,e){for(let n of e)for(let r in n.channels){let{scale:o}=n.channels[r];if(o===t||o==="projection")return!0}return!1}function W5(t,e){for(let n in t){let r=t[n],o=e[n];r.label===void 0&&o&&(r.label=o.label)}return t}function H5({fx:t,fy:e},n){let{marginTop:r,marginRight:o,marginBottom:i,marginLeft:a,width:f,height:u}=Rc(n),c=t&&hy(t),s=e&&hy(e);return{marginTop:e?s[0]:r,marginRight:t?f-c[1]:o,marginBottom:e?u-s[1]:i,marginLeft:t?c[0]:a,inset:{marginTop:n.marginTop,marginRight:n.marginRight,marginBottom:n.marginBottom,marginLeft:n.marginLeft},width:f,height:u}}function hy(t){let e=t.domain(),n=t(e[0]),r=t(e[e.length-1]);return r<n&&([n,r]=[r,n]),[n,r+t.bandwidth()]}function Tp(t={y:"count"},e={}){[t,e]=V5(t,e);let{x:n,y:r}=e;return G5(j5(n,e,wt),null,null,r,t,Oo(e))}function G5(t,e,n,r,{data:o=kd,filter:i=ba,sort:a,reverse:f,...u}={},c={}){t=xy(t),e=xy(e),u=K5(u,c),o=vy(o,wt),a=a==null?void 0:by("sort",a,c),i=i==null?void 0:wy("filter",i,c),n!=null&&wa(u,"x","x1","x2")&&(n=null),r!=null&&wa(u,"y","y1","y2")&&(r=null);let[s,d]=Te(t),[l,p]=Te(t),[m,h]=Te(e),[g,b]=Te(e),[x,M]=n!=null?[n,"x"]:r!=null?[r,"y"]:[],[y,w]=Te(x),{x:v,y:T,z:E,fill:I,stroke:D,x1:_,x2:L,y1:F,y2:P,domain:S,cumulative:A,thresholds:N,interval:O,...R}=c,[tt,Z]=Te(E),[H]=ie(I),[Q]=ie(D),[at,Ut]=Te(H),[Oe,G]=Te(Q);return{..."z"in c&&{z:tt||E},..."fill"in c&&{fill:at||I},..."stroke"in c&&{stroke:Oe||D},...Ao(R,(X,$,q)=>{let Y=ya(gt(X,x),q?.[M]),C=gt(X,E),j=gt(X,H),J=gt(X,Q),ot=Wg(u,{z:C,fill:j,stroke:J}),lt=[],Xt=[],Zn=Y&&w([]),ka=C&&Z([]),Da=j&&Ut([]),Na=J&&G([]),Ra=t&&d([]),rs=t&&p([]),Ap=e&&h([]),Dy=e&&b([]),Ny=e3(t?.(X),e?.(X)),Ry=0;for(let Dr of u)Dr.initialize(X);a&&a.initialize(X),i&&i.initialize(X);for(let Dr of $){let $p=[];for(let zo of u)zo.scope("facet",Dr);a&&a.scope("facet",Dr),i&&i.scope("facet",Dr);for(let[zo,Ly]of Id(Dr,ot))for(let[Py,Oy]of Id(Ly,Y))for(let[Kn,Qn]of Ny(Oy))if(!(i&&!i.reduce(Kn,Qn))){$p.push(Ry++),Xt.push(o.reduceIndex(Kn,X,Qn)),Y&&Zn.push(Py),C&&ka.push(ot===C?zo:C[Kn[0]]),j&&Da.push(ot===j?zo:j[Kn[0]]),J&&Na.push(ot===J?zo:J[Kn[0]]),Ra&&(Ra.push(Qn.x1),rs.push(Qn.x2)),Ap&&(Ap.push(Qn.y1),Dy.push(Qn.y2));for(let Fy of u)Fy.reduce(Kn,Qn);a&&a.reduce(Kn)}lt.push($p)}return Hg(lt,a,f),{data:Xt,facets:lt}}),...!wa(u,"x")&&(s?{x1:s,x2:l,x:xa(s,l)}:{x:v,x1:_,x2:L}),...!wa(u,"y")&&(m?{y1:m,y2:g,y:xa(m,g)}:{y:T,y1:F,y2:P}),...y&&{[M]:y},...Object.fromEntries(u.map(({name:X,output:$})=>[X,$]))}}function V5({cumulative:t,domain:e,thresholds:n,interval:r,...o},i){return[o,{cumulative:t,domain:e,thresholds:n,interval:r,...i}]}function j5(t,{cumulative:e,domain:n,thresholds:r,interval:o},i){return t={...rn(t)},t.domain===void 0&&(t.domain=n),t.cumulative===void 0&&(t.cumulative=e),t.thresholds===void 0&&(t.thresholds=r),t.interval===void 0&&(t.interval=o),t.value===void 0&&(t.value=i),t.thresholds=Z5(t.thresholds,t.interval),t}function xy(t){if(t==null)return;let{value:e,cumulative:n,domain:r=Ct,thresholds:o}=t,i=a=>{let f=gt(a,e),u;if(zt(f)||J5(o)){f=pt(f,bd,Float64Array);let[s,d]=typeof r=="function"?r(f):r,l=typeof o=="function"&&!Ia(o)?o(f,s,d):o;typeof l=="number"&&(l=Ui(s,d,l)),Ia(l)&&(r===Ct&&(s=l.floor(s),d=l.offset(l.floor(d))),l=l.range(s,l.offset(d))),u=l}else{f=Tr(f);let[s,d]=typeof r=="function"?r(f):r,l=typeof o=="function"&&!Ia(o)?o(f,s,d):o;if(typeof l=="number")if(r===Ct){let p=tr(s,d,l);if(isFinite(p))if(p>0){let m=Math.round(s/p),h=Math.round(d/p);m*p<=s||--m,h*p>d||++h;let g=h-m+1;l=new Float64Array(g);for(let b=0;b<g;++b)l[b]=(m+b)*p}else if(p<0){p=-p;let m=Math.round(s*p),h=Math.round(d*p);m/p<=s||--m,h/p>d||++h;let g=h-m+1;l=new Float64Array(g);for(let b=0;b<g;++b)l[b]=(m+b)/p}else l=[s];else l=[s]}else l=Ae(s,d,l);else Ia(l)&&(r===Ct&&(s=l.floor(s),d=l.offset(l.floor(d))),l=l.range(s,l.offset(d)));u=l}let c=[];if(u.length===1)c.push([u[0],u[0]]);else for(let s=1;s<u.length;++s)c.push([u[s-1],u[s]]);return c.bin=(n<0?r3:n>0?n3:_p)(c,u,f),c};return i.label=Re(e),i}function Z5(t,e,n=yy){if(t===void 0)return e===void 0?n:nn(e);if(typeof t=="string"){switch(t.toLowerCase()){case"freedman-diaconis":return Ba;case"scott":return Go;case"sturges":return Fa;case"auto":return yy}return Tc(t)}return t}function K5(t,e){return Xg(t,e,by)}function by(t,e,n){return $d(t,e,n,wy)}function wy(t,e,n){return Ed(t,e,n,vy)}function vy(t,e){return va(t,e,Q5)}function Q5(t){switch(`${t}`.toLowerCase()){case"x":return o3;case"x1":return a3;case"x2":return f3;case"y":return i3;case"y1":return u3;case"y2":return c3}throw new Error(`invalid bin reduce: ${t}`)}function yy(t,e,n){return Math.min(200,Go(t,e,n))}function J5(t){return t3(t)||re(t)&&zt(t)}function t3(t){return Ia(t)&&typeof t=="function"&&t()instanceof Date}function Ia(t){return typeof t?.range=="function"}function e3(t,e){return t&&e?function*(n){let r=t.bin(n);for(let[o,[i,a]]of t.entries()){let f=e.bin(r[o]);for(let[u,[c,s]]of e.entries())yield[f[u],{x1:i,y1:c,x2:a,y2:s}]}}:t?function*(n){let r=t.bin(n);for(let[o,[i,a]]of t.entries())yield[r[o],{x1:i,x2:a}]}:function*(n){let r=e.bin(n);for(let[o,[i,a]]of e.entries())yield[r[o],{y1:i,y2:a}]}}function _p(t,e,n){return e=Tr(e),r=>{let o=t.map(()=>[]);for(let i of r)o[un(e,n[i])-1]?.push(i);return o}}function n3(t,e,n){let r=_p(t,e,n);return o=>{let i=r(o);for(let a=1,f=i.length;a<f;++a){let u=i[a-1],c=i[a];for(let s of u)c.push(s)}return i}}function r3(t,e,n){let r=_p(t,e,n);return o=>{let i=r(o);for(let a=i.length-2;a>=0;--a){let f=i[a+1],u=i[a];for(let c of f)u.push(c)}return i}}function My(t,e){let n=(+t+ +e)/2;return t instanceof Date?new Date(n):n}var o3={reduceIndex(t,e,{x1:n,x2:r}){return My(n,r)}},i3={reduceIndex(t,e,{y1:n,y2:r}){return My(n,r)}},a3={reduceIndex(t,e,{x1:n}){return n}},f3={reduceIndex(t,e,{x2:n}){return n}},u3={reduceIndex(t,e,{y1:n}){return n}},c3={reduceIndex(t,e,{y2:n}){return n}};function Sy(t={}){return wd(t)?t:{...t,y:wt}}function s3(t={},e={}){arguments.length===1&&([t,e]=l3(t));let{x1:n,x:r=n,y:o,...i}=e,[a,f,u,c]=p3(r,o,"x","y",t,i);return{...a,x1:n,x:f,y1:u,y2:c,y:xa(u,c)}}function Cy({y:t,y1:e,y2:n,...r}={}){return r=Ca(r,"x"),e===void 0&&n===void 0?s3({y:t,...r}):([e,n]=Tg(t,e,n),{...r,y1:e,y2:n})}function l3(t){let{offset:e,order:n,reverse:r,...o}=t;return[{offset:e,order:n,reverse:r},o]}var d3={length:!0};function p3(t,e=yg,n,r,{offset:o,order:i,reverse:a},f){let u=_g(f),[c,s]=Te(t),[d,l]=bo(e),[p,m]=bo(e);return d.hint=p.hint=d3,o=m3(o),i=x3(i,o,r),[Ao(f,(h,g,b)=>{let x=t==null?void 0:s(ya(gt(h,t),b?.[n])),M=gt(h,e,Float64Array),y=gt(h,u),w=i&&i(h,x,M,y),v=h.length,T=l(new Float64Array(v)),E=m(new Float64Array(v)),I=[];for(let D of g){let _=x?Array.from(sn(D,L=>x[L]).values()):[D];if(w)for(let L of _)L.sort(w);for(let L of _){let F=0,P=0;a&&L.reverse();for(let S of L){let A=M[S];A<0?F=E[S]=(T[S]=F)+A:A>0?P=E[S]=(T[S]=P)+A:E[S]=T[S]=P}}I.push(_)}return o&&o(I,T,E,y),{data:h,facets:g}}),c,d,p]}function m3(t){if(t!=null){if(typeof t=="function")return t;switch(`${t}`.toLowerCase()){case"expand":case"normalize":return h3;case"center":case"silhouette":return g3;case"wiggle":return $y}throw new Error(`unknown offset: ${t}`)}}function Ay(t,e){let n=0,r=0;for(let o of t){let i=e[o];i<n&&(n=i),i>r&&(r=i)}return[n,r]}function h3(t,e,n){for(let r of t)for(let o of r){let[i,a]=Ay(o,n);for(let f of o){let u=1/(a-i||1);e[f]=u*(e[f]-i),n[f]=u*(n[f]-i)}}}function g3(t,e,n){for(let r of t){for(let o of r){let[i,a]=Ay(o,n);for(let f of o){let u=(a+i)/2;e[f]-=u,n[f]-=u}}Ey(r,e,n)}Iy(t,e,n)}function $y(t,e,n,r){for(let o of t){let i=new Qt,a=0;for(let f of o){let u=-1,c=f.map(p=>Math.abs(n[p]-e[p])),s=f.map(p=>{u=r?r[p]:++u;let m=n[p]-e[p],h=i.has(u)?m-i.get(u):0;return i.set(u,m),h}),d=[0,...Pa(s)];for(let p of f)e[p]+=a,n[p]+=a;let l=fe(c);l&&(a-=fe(c,(p,m)=>(s[m]/2+d[m])*p)/l)}Ey(o,e,n)}Iy(t,e,n)}function Ey(t,e,n){let r=Jt(t,o=>Jt(o,i=>e[i]));for(let o of t)for(let i of o)e[i]-=r,n[i]-=r}function Iy(t,e,n){let r=t.length;if(r===1)return;let o=t.map(f=>f.flat()),i=o.map(f=>(Jt(f,u=>e[u])+Wt(f,u=>n[u]))/2),a=Jt(i);for(let f=0;f<r;f++){let u=a-i[f];for(let c of o[f])e[c]+=u,n[c]+=u}}function x3(t,e,n){if(t===void 0&&e===$y)return Ty(Kt);if(t!=null){if(typeof t=="string"){let r=t.startsWith("-"),o=r?Mr:Kt;switch((r?t.slice(1):t).toLowerCase()){case"value":case n:return y3(o);case"z":return b3(o);case"sum":return w3(o);case"appearance":return v3(o);case"inside-out":return Ty(o)}return _y(xd(t))}if(typeof t=="function")return(t.length===1?_y:M3)(t);if(Array.isArray(t))return S3(t);throw new Error(`invalid order: ${t}`)}}function y3(t){return(e,n,r)=>(o,i)=>t(r[o],r[i])}function b3(t){return(e,n,r,o)=>(i,a)=>t(o[i],o[a])}function w3(t){return ts(t,(e,n,r,o)=>Lr(ne(e),i=>fe(i,a=>r[a]),i=>o[i]))}function v3(t){return ts(t,(e,n,r,o)=>Lr(ne(e),i=>n[Ho(i,a=>r[a])],i=>o[i]))}function Ty(t){return ts(t,(e,n,r,o)=>{let i=ne(e),a=Lr(i,d=>n[Ho(d,l=>r[l])],d=>o[d]),f=Ce(i,d=>fe(d,l=>r[l]),d=>o[d]),u=[],c=[],s=0;for(let d of a)s<0?(s+=f.get(d),u.push(d)):(s-=f.get(d),c.push(d));return c.reverse().concat(u)})}function _y(t){return e=>{let n=gt(e,t);return(r,o)=>Kt(n[r],n[o])}}function M3(t){return e=>(n,r)=>t(e[n],e[r])}function S3(t){return ts(Kt,()=>t)}function ts(t,e){return(n,r,o,i)=>{if(!i)throw new Error("missing channel: z");let a=new Qt(e(n,r,o,i).map((f,u)=>[f,u]));return(f,u)=>t(a.get(i[f]),a.get(i[u]))}}var T3={ariaLabel:"rect"},es=class extends Dt{constructor(e,n={}){let{x1:r,y1:o,x2:i,y2:a,inset:f=0,insetTop:u=f,insetRight:c=f,insetBottom:s=f,insetLeft:d=f,rx:l,ry:p}=n;super(e,{x1:{value:r,scale:"x",optional:!0},y1:{value:o,scale:"y",optional:!0},x2:{value:i,scale:"x",optional:!0},y2:{value:a,scale:"y",optional:!0}},n,T3),this.insetTop=ct(u),this.insetRight=ct(c),this.insetBottom=ct(s),this.insetLeft=ct(d),this.rx=St(l,"auto"),this.ry=St(p,"auto")}render(e,n,r,o,i){let{x:a,y:f}=n,{x1:u,y1:c,x2:s,y2:d}=r,{marginTop:l,marginRight:p,marginBottom:m,marginLeft:h,width:g,height:b}=o,{projection:x}=i,{insetTop:M,insetRight:y,insetBottom:w,insetLeft:v,rx:T,ry:E}=this;return yt("svg:g",i).call(me,this,o,i).call(ge,this,{x:u&&s&&a,y:c&&d&&f},0,0).call(I=>I.selectAll().data(e).enter().append("rect").call(he,this).attr("x",u&&s&&(x||!fn(a))?D=>Math.min(u[D],s[D])+v:h+v).attr("y",c&&d&&(x||!fn(f))?D=>Math.min(c[D],d[D])+M:l+M).attr("width",u&&s&&(x||!fn(a))?D=>Math.max(0,Math.abs(s[D]-u[D])-v-y):g-p-h-y-v).attr("height",c&&d&&(x||!fn(f))?D=>Math.max(0,Math.abs(c[D]-d[D])-M-w):b-l-m-M-w).call(et,"rx",T).call(et,"ry",E).call(Pe,this,r)).node()}};function Cp(t,e={}){return Sg(e)||(e={...e,x:_c,y2:wt,interval:1}),new es(t,Cy(hx(Sy(e))))}var ns=class{constructor(e){this.el=e;document.addEventListener("click",n=>{this.el.contains(n.target)||this.el.removeAttribute("open")})}};for(let t of document.querySelectorAll(".js-tooltip"))new ns(t);window.onload=function(){ky(),A3(),$3(),E3(),C3()};function C3(){let t=document.querySelector("html");for(let e of document.querySelectorAll("h2"))e.addEventListener("click",function(){let n=localStorage.getItem("closed-sections")?.split(",");if(n?.includes(this.id)){n=n.filter(o=>o!==this.id);let r=n.join(",");localStorage.setItem("closed-sections",r),t.setAttribute("data-closed-sections",r)}else{n=[this.id].concat(n??[]);let r=n.join(",");localStorage.setItem("closed-sections",r),t.setAttribute("data-closed-sections",r)}})}function ky(){for(let t of Page.Charts??[])for(let e of t.Counters){let n=()=>{let a=new Set(e.Data.map(s=>s.Week).sort()),f=new Date(Array.from(a.values()).at(0)??0),u=new Date,c=1e3*60*60*24;return Math.ceil(Math.abs(u.getTime()-f.getTime())/c)<30&&(f.setDate(f.getDate()-29),u.setDate(u.getDate()+1)),[f,u]},o={tip:!0,x:a=>new Date(a.Week),y:a=>a.Value,interval:"week",fill:a=>{let f=Number(a.Key);return isNaN(f)?a.Key:f},fy:a=>{let f=[];for(let u of["Version","GoVersion"])new URLSearchParams(location.search).get(u)==="on"&&f.push(a[u]||"empty");return f.join(" / ")}},i=Jc({x:{domain:n(),label:"Week"},y:{label:"Value"},color:{type:"ordinal",legend:!0,scheme:"Spectral",reverse:!0,label:"Counter"},style:"overflow:visible;width:100%;background:transparent",marks:[Cp(e.Data,Tp({y:"sum"},o)),Aa([0])]});document.querySelector(`[data-chart-id="${e.ID}"]`)?.replaceChildren(i)}}function A3(){let e=document.querySelector(".js-facets")?.querySelectorAll("input")??[];for(let n of e){let r=new URLSearchParams(location.search);n.checked=r.get(n.value)==="on",n.addEventListener("change",()=>{let o=new URLSearchParams(location.search);o.set(n.value,n.checked?"on":"off"),history.replaceState(null,"","?"+o.toString()),ky()})}}function $3(){let t=document.querySelector(".js-selectConfig");t?.addEventListener("change",()=>{let e=new URLSearchParams(location.search);e.set(t.name,t.value),history.replaceState(null,"","?"+e.toString()),location.reload()})}function E3(){let t=document.querySelectorAll("h1, h2, h3, h4"),e=I3(()=>{let r=[];for(let u of t){let c=u.getBoundingClientRect();c.height&&c.top<80&&r.unshift(u)}r.length<2&&(r=[]);let o=1/0,i=[];for(let u of r){let c=Number(u.tagName[1]);c<o&&(o=c,i.unshift(u))}let a=document.querySelector(".js-breadcrumb ol"),f=[];for(let u of i){a?.replaceChildren;let c=document.createElement("li"),s=document.createElement("a");s.href=`#${u.id}`,s.innerText=u.getAttribute("data-label")??u.innerText,c.appendChild(s),f.push(c)}a?.replaceChildren(...f)},100),n=new IntersectionObserver(e);for(let r of t)n.observe(r)}function I3(t,e){let n;return(...r)=>{clearTimeout(n),n=setTimeout(()=>t(...r),e)}}})();
/**
 * @license
